...
> = {
	...
	low:    { wuPerWeek: 1, cashPerWeek: 100,  growthBoost: 0.15, decayReduction: 0.1 },
	medium: { wuPerWeek: 2, cashPerWeek: 350,  growthBoost: 0.35, decayReduction: 0.25 },
	high:   { wuPerWeek: 3, cashPerWeek: 900,  growthBoost: 0.65, decayReduction: 0.4 }
};
...
export const CAMPAIGN_DEFINITIONS: CampaignDef[] = [
	{
		...
		wuRequired: 3,
		cashCost: 200,
		effect: { growthMultiplier: 0.8, decayReduction: 0.1, durationWeeks: 4 }
	},
	{
		type: 'press_release',
		label: 'Press Release',
		wuRequired: 2,
		cashCost: 500,
		effect: { growthMultiplier: 0.5, decayReduction: 0.15, durationWeeks: 3 }
	},
	{
		...
		wuRequired: 4,
		cashCost: 1500,
		effect: { growthMultiplier: 1.2, decayReduction: 0.2, durationWeeks: 6 }
	},
	{
		...
		wuRequired: 5,
		cashCost: 0,
		effect: { growthMultiplier: 2.0, decayReduction: 0.1, durationWeeks: 3 }
	},
	{
		type: 'paid_ads',
		label: 'Paid Ads',
		wuRequired: 1,
		cashCost: 2000,
		effect: { growthMultiplier: 0.9, decayReduction: 0.3, durationWeeks: 5 }
	},
	{
		...
		wuRequired: 6,
		cashCost: 300,
		effect: { growthMultiplier: 0.6, decayReduction: 0.35, durationWeeks: 8 }
	}
];
